...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        log.debug("GetRecipe method has been run");
        ...
        Recipe guacomale = new Recipe();
        guacomale.setDescription("Perfect Guacamole");
        guacomale.setPrepTime(10);
        guacomale.setCookTime(5);
        guacomale.setDifficulty(Difficulty.EASY);
        
        guacomale.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
